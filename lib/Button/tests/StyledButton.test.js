...
var _ref =
/*#__PURE__*/
(0, _jsx2["default"])(_StyledButton["default"], {});
...
describe('<StyledButton />', function () {
  it('should render an <button> tag', function () {
    ...
    var renderedComponent = (0, _testUtils.enzymeFind)(wrapper, _StyledButton["default"]);
  ...
  it('should adopt a valid attribute', function () {
    var id = 'test';
    var wrapper = (0, _enzyme.mount)((0, _jsx2["default"])(_StyledButton["default"], {
      id: id
    }));
    var renderedComponent = (0, _testUtils.enzymeFind)(wrapper, _StyledButton["default"]);
