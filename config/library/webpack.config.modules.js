...
const cssFilename = '[name]/style.css';
...
const modules = {};
const files = fs.readdirSync(libPaths.libComponentsPath);

files.forEach(function(name) {
  const p = path.join(libPaths.libComponentsPath, name);
